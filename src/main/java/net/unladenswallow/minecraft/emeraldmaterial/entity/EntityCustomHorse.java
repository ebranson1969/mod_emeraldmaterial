package net.unladenswallow.minecraft.emeraldmaterial.entity;
...
/**
 * A custom horse entity that can wear Emerald Horse Armor; designed to replace the vanilla EntityHorse
 * 
...
//	public EntityCustomHorse(World worldIn) {
//		super(worldIn);
//		EMLogger.info("EntityCustomHorse <init>");
//	}
	...
	private static final Predicate horseBreedingSelector = new Predicate()
    {
        ...
        {
            return p_179873_1_ instanceof EntityCustomHorse && ((EntityCustomHorse)p_179873_1_).func_110205_ce();
        }
    ...
    {
        EMLogger.info("EntityCustomHorse entityInit");
        super.entityInit();
...
//        this.dataWatcher.addObject(22, Integer.valueOf(0));
    ...
    {
        EMLogger.info("EntityCustomHorse setHorseType");
    ...
    {
//        EMLogger.info("EntityCustomHorse getHorseType");
        return this.dataWatcher.getWatchableObjectByte(19);
    }

    public void setHorseVariant(int p_110235_1_)
    {
        EMLogger.info("EntityCustomHorse setHorseVariant");
    ...
    {
//        EMLogger.info("EntityCustomHorse getHorseVariant");
    ...
    {
//        EMLogger.info("EntityCustomHorse getName");
    ...
    {
//        EMLogger.info("EntityCustomHorse getHorseWatchableBoolean");
    ...
    {
        EMLogger.info("EntityCustomHorse setHorseWatchableBoolean: int = " + p_110208_1_ + "; boolean = " + p_110208_2_);
    ...
    {
//        EMLogger.info("EntityCustomHorse isAdultHorse");
        return !this.isChild();
    }

    public boolean isTame()
    {
//        EMLogger.info("EntityCustomHorse isTame");
        return this.getHorseWatchableBoolean(2);
    }

    public boolean func_110253_bW()
    {
        EMLogger.info("EntityCustomHorse func_110253_bW");
        return this.isAdultHorse();
    }

    public String func_152119_ch()
    {
//        EMLogger.info("EntityCustomHorse func_152119_ch");
        return this.dataWatcher.getWatchableObjectString(21);
    }

    public void func_152120_b(String p_152120_1_)
    {
        EMLogger.info("EntityCustomHorse func_152120_b");
        this.dataWatcher.updateObject(21, p_152120_1_);
    }

    public float getHorseSize()
    {
//        EMLogger.info("EntityCustomHorse getHorseSize");
    ...
    {
//        EMLogger.info("EntityCustomHorse setScaleForAge");
        if (p_98054_1_)
        {
    ...
    {
        EMLogger.info("EntityCustomHorse isHorseJumping");
        return this.horseJumping;
    }

    public void setHorseTamed(boolean p_110234_1_)
    {
        EMLogger.info("EntityCustomHorse setHorseTamed");
       this.setHorseWatchableBoolean(2, p_110234_1_);
    }

    public void setHorseJumping(boolean p_110255_1_)
    {
//        EMLogger.info("EntityCustomHorse setHorseJumping");
        this.horseJumping = p_110255_1_;
    }

    public boolean allowLeashing()
    {
        EMLogger.info("EntityCustomHorse allowLeashing");
        return !this.isUndead() && super.allowLeashing();
    }

    protected void func_142017_o(float p_142017_1_)
    {
//        EMLogger.info("EntityCustomHorse func_142017_o");
    ...
    {
//        EMLogger.info("EntityCustomHorse isChested");
        return this.getHorseWatchableBoolean(8);
    }

    public int func_110241_cb()
    {
        EMLogger.info("EntityCustomHorse func_110241_cb: watchableObject 22 = " + this.dataWatcher.getWatchableObjectInt(22));
        return this.dataWatcher.getWatchableObjectInt(22);
    }

    /**
     * 0 = iron, 1 = gold, 2 = diamond, 4 = emerald
     */
    private int getHorseArmorIndex(ItemStack p_110260_1_)
    {
        if (p_110260_1_ == null)
        {
        	EMLogger.info("EntityCustomHorse getHorseArmorIndex(): 0 (ItemStack is null)");
            return 0;
        }
        else
        {
            Item item = p_110260_1_.getItem();
        	EMLogger.info("EntityCustomHorse getHorseArmorIndex(): item = " + p_110260_1_.getDisplayName() + "; result = "+ (item == Items.iron_horse_armor ? 1 : (item == Items.golden_horse_armor ? 2 : (item == Items.diamond_horse_armor ? 3 : (item == ModEmeraldMaterial.emeraldHorseArmor ? 4 : 0)))));
            return item == Items.iron_horse_armor ? 1 : (item == Items.golden_horse_armor ? 2 : (item == Items.diamond_horse_armor ? 3 : (item == ModEmeraldMaterial.emeraldHorseArmor ? 4 : 0)));
        }
    }

    public boolean isEatingHaystack()
    {
//        EMLogger.info("EntityCustomHorse isEatingHaystack");
        return this.getHorseWatchableBoolean(32);
    }

    public boolean isRearing()
    {
//        EMLogger.info("EntityCustomHorse isRearing");
        return this.getHorseWatchableBoolean(64);
    }

    public boolean func_110205_ce()
    {
//        EMLogger.info("EntityCustomHorse func_110205_ce");
        return this.getHorseWatchableBoolean(16);
    }

    public boolean getHasReproduced()
    {
//        EMLogger.info("EntityCustomHorse getHasReproduced");
    ...
    {
        EMLogger.info("EntityCustomHorse setHorseArmorStack: item = " + (p_146086_1_ == null ? "null" : p_146086_1_.getDisplayName()));
        EMLogger.info("EntityCustomHorse setHorseArmorStack: horseArmorIndex = " + this.getHorseArmorIndex(p_146086_1_));
...
//        EMLogger.info("EntityCustomHorse getTemper");
    ...
    {
        EMLogger.info("EntityCustomHorse attackEntityFrom");
    ...
    {
        EMLogger.info("EntityCustomHorse getTotalArmorValue");
    ...
    {
//        EMLogger.info("EntityCustomHorse canBePushed");
        return this.riddenByEntity == null;
    }

    public boolean prepareChunkForSpawn()
    {
        EMLogger.info("EntityCustomHorse prepareChunkForSpawn");
    ...
    {
        EMLogger.info("EntityCustomHorse dropChests");
    ...
    {
        EMLogger.info("EntityCustomHorse func_110266_cB");
        this.openHorseMouth();
    ...
    {
//        EMLogger.info("EntityCustomHorse fall");
        if (distance > 1.0F)
        {
    ...
    {
        EMLogger.info("EntityCustomHorse func_110225_cC");
        int i = this.getHorseType();
    ...
    {
        EMLogger.info("EntityCustomHorse func_110226_cD");
    ...
    private void func_110232_cE()
    {
        ...
        {
            EMLogger.info("EntityCustomHorse func_110232_cE: setting horseSaddled = " + (this.horseChest.getStackInSlot(0) != null));
            this.setHorseSaddled(this.horseChest.getStackInSlot(0) != null);

            if (this.canWearArmor())
            {
                EMLogger.info("EntityCustomHorse func_110232_cE: setting horseArmorStack = " + this.horseChest.getStackInSlot(1));
    ...
    {
    	EMLogger.info("EntityCustomHorse onInventoryChanged(): slots = " + p_76316_1_.getSizeInventory());
    	for (int i = 0; i < p_76316_1_.getSizeInventory(); i++) {
        	EMLogger.info("EntityCustomHorse onInventoryChanged(): slots " + i + " = " + (p_76316_1_.getStackInSlot(i) == null ? "empty" : p_76316_1_.getStackInSlot(i).getDisplayName()));
    	}
    ...
    {
        EMLogger.info("EntityCustomHorse getCanSpawnHere");
        this.prepareChunkForSpawn();
        return super.getCanSpawnHere();
    }

    protected EntityCustomHorse getClosestHorse(Entity p_110250_1_, double p_110250_2_)
    {
        EMLogger.info("EntityCustomHorse getClosestHorse");
        ...
        return (EntityCustomHorse)entity1;
    }

    public double getHorseJumpStrength()
    {
//        EMLogger.info("EntityCustomHorse getHorseJumpStrength");
    ...
    {
        EMLogger.info("EntityCustomHorse getDeathSound");
        this.openHorseMouth();
        int i = this.getHorseType();
    ...
    {
        EMLogger.info("EntityCustomHorse getDropItem");
    ...
    {
        EMLogger.info("EntityCustomHorse getHurtSound");
        this.openHorseMouth();
    ...
    {
//        EMLogger.info("EntityCustomHorse isHorseSaddled");
    ...
    {
//        EMLogger.info("EntityCustomHorse getLivingSound");
        this.openHorseMouth();
    ...
    {
        EMLogger.info("EntityCustomHorse getAngrySoundName");
        this.openHorseMouth();
        this.makeHorseRear();
        int i = this.getHorseType();
    ...
    {
//        EMLogger.info("EntityCustomHorse playStepSound");
    ...
    {
        EMLogger.info("EntityCustomHorse applyEntityAttributes");
...
//        this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(0.22499999403953552D);
    ...
    {
        EMLogger.info("EntityCustomHorse getMaxSpawnedInChunk");
        return 6;
    }

    public int getMaxTemper()
    {
        EMLogger.info("EntityCustomHorse getMaxTemper");
        return 100;
    }
    ...
    {
//        EMLogger.info("EntityCustomHorse getSoundVolume");
        return 0.8F;
    }
    ...
    {
//        EMLogger.info("EntityCustomHorse getTalkInterval");
        return 400;
    }
    ...
    {
//        EMLogger.info("EntityCustomHorse func_110239_cn");
        return this.getHorseType() == 0 || this.func_110241_cb() > 0;
    }

    private void resetTexturePrefix()
    {
        EMLogger.info("EntityCustomHorse resetTexturePrefix");
    ...
    {
//        EMLogger.info("EntityCustomHorse func_175507_cI");
    ...
    {
        EMLogger.info("EntityCustomHorse setHorseTexturePaths");
    	...
    	EMLogger.info("EntityCustomHorse setHorseTexturePaths()"
    			+ "; field_110280_bR[0] = " + field_110280_bR[0]
    			+ "; field_110280_bR[1] = " + field_110280_bR[1]
    			+ "; field_110280_bR[2] = " + field_110280_bR[2]
    			+ "; texturePrefix = " + texturePrefix
    			+ "; field_175508_bO = " + field_175508_bO
    					);
    }
    ...
    {
//        EMLogger.info("EntityCustomHorse getHorseTexture");
    ...
    {
        EMLogger.info("EntityCustomHorse getVariantTexturePaths");
        if (this.texturePrefix == null)
        {
            this.setHorseTexturePaths();
        }
    ...
    {
        EMLogger.info("EntityCustomHorse openGUI");
    ...
    {
        EMLogger.info("EntityCustomHorse interact");
        ...
        else
        {
            if (itemstack != null)
            {
                ...
                if (this.canWearArmor())
                {
                    ...
                    else if (itemstack.getItem() == ModEmeraldMaterial.emeraldHorseArmor)
                    {
                        b0 = 4;
                    }

                    EMLogger.info("EntityCustomHorse interact(): b0 = " + b0);
                    if (b0 >= 0)
                    {
                        if (!this.isTame())
                        {
    ...
    {
        EMLogger.info("EntityCustomHorse func_110237_h");
    ...
    {
//        EMLogger.info("EntityCustomHorse canWearArmor");
    ...
    {
        EMLogger.info("EntityCustomHorse canCarryChest");
        int i = this.getHorseType();
        return i == 2 || i == 1;
    }
    ...
    {
//        EMLogger.info("EntityCustomHorse isMovementBlocked");
    ...
    {
        EMLogger.info("EntityCustomHorse isUndead");
        int i = this.getHorseType();
        return i == 3 || i == 4;
    }
    ...
    {
        EMLogger.info("EntityCustomHorse isSterile");
    ...
    {
//        EMLogger.info("EntityCustomHorse func_110210_cH");
    ...
    {
        EMLogger.info("EntityCustomHorse onDeath");
        super.onDeath(cause);
//
//        if (!this.worldObj.isRemote)
//        {
...
//        }
    ...
    {
//        EMLogger.info("EntityCustomHorse onLivingUpdate");
        ...
        if (!this.worldObj.isRemote)
        {
            ...
            {
                EntityCustomHorse entityhorse = this.getClosestHorse(this, 16.0D);
    ...
    {
//        EMLogger.info("EntityCustomHorse onUpdate");
        super.onUpdate();
    ...
    {
//        EMLogger.info("EntityCustomHorse openHorseMouth");
        if (!this.worldObj.isRemote)
        {
    ...
    {
//        EMLogger.info("EntityCustomHorse canMate");
    ...
    {
//        EMLogger.info("EntityCustomHorse setEating");
        this.setHorseWatchableBoolean(32, eating);
    }

    public void setEatingHaystack(boolean p_110227_1_)
    {
//        EMLogger.info("EntityCustomHorse setEatingHaystack");
        this.setEating(p_110227_1_);
    }

    public void setRearing(boolean p_110219_1_)
    {
        EMLogger.info("EntityCustomHorse setRearing");
        if (p_110219_1_)
        {
            this.setEatingHaystack(false);
        }
    ...
    {
        EMLogger.info("EntityCustomHorse makeHorseRear");
        if (!this.worldObj.isRemote)
        {
    ...
    {
        EMLogger.info("EntityCustomHorse makeHorseRearWithSound");
        this.makeHorseRear();
    ...
    {
        EMLogger.info("EntityCustomHorse dropChestItems");
    ...
    {
        EMLogger.info("EntityCustomHorse dropItemsInChest");
    ...
    {
        EMLogger.info("EntityCustomHorse setTamedBy");
    ...
    {
//        EMLogger.info("EntityCustomHorse moveEntityWithHeading");
    ...
    {
        EMLogger.info("EntityCustomHorse writeEntityToNBT");
    ...
    {
        EMLogger.info("EntityCustomHorse readEntityFromNBT");
    ...
    {
        EMLogger.info("EntityCustomHorse canMateWith");
        if (otherAnimal == this)
        {
            return false;
        }
        ...
        {
            EntityCustomHorse entityhorse = (EntityCustomHorse)otherAnimal;
    ...
    {
        EMLogger.info("EntityCustomHorse createChild");
        EntityCustomHorse entityhorse = (EntityCustomHorse)ageable;
        EntityCustomHorse entityhorse1 = new EntityCustomHorse(this.worldObj);
        int i = this.getHorseType();
        int j = entityhorse.getHorseType();
        int k = 0;
    ...
    {
        EMLogger.info("EntityCustomHorse func_180482_a");
        ...
        if (p_180482_2_1 instanceof EntityCustomHorse.GroupData)
        {
            l = ((EntityCustomHorse.GroupData)p_180482_2_1).field_111107_a;
            i = ((EntityCustomHorse.GroupData)p_180482_2_1).field_111106_b & 255 | this.rand.nextInt(5) << 8;
        }
        else
        {
            ...
            p_180482_2_1 = new EntityCustomHorse.GroupData(l, i);
        }
    ...
    {
//        EMLogger.info("EntityCustomHorse getGrassEatingAmount");
    ...
    {
//        EMLogger.info("EntityCustomHorse getRearingAmount");
    ...
    {
//        EMLogger.info("EntityCustomHorse func_110201_q");
        return this.prevMouthOpenness + (this.mouthOpenness - this.prevMouthOpenness) * p_110201_1_;
    }

    public void setJumpPower(int p_110206_1_)
    {
        EMLogger.info("EntityCustomHorse setJumpPower");
    ...
    {
        EMLogger.info("EntityCustomHorse spawnHorseParticles");
    ...
    {
        EMLogger.info("EntityCustomHorse handleHealthUpdate");
        if (p_70103_1_ == 7)
        {
    ...
    {
//        EMLogger.info("EntityCustomHorse updateRiderPosition");
    ...
    {
        EMLogger.info("EntityCustomHorse func_110267_cL");
        return 15.0F + (float)this.rand.nextInt(8) + (float)this.rand.nextInt(9);
    }

    private double func_110245_cM()
    {
        EMLogger.info("EntityCustomHorse func_110245_cM");
        return 0.4000000059604645D + this.rand.nextDouble() * 0.2D + this.rand.nextDouble() * 0.2D + this.rand.nextDouble() * 0.2D;
    }

    private double func_110203_cN()
    {
        EMLogger.info("EntityCustomHorse func_110203_cN");
        return (0.44999998807907104D + this.rand.nextDouble() * 0.3D + this.rand.nextDouble() * 0.3D + this.rand.nextDouble() * 0.3D) * 0.25D;
    }

    public static boolean func_146085_a(Item p_146085_0_)
    {
    	EMLogger.info("EntityCustomHorse func_146085_a(): " + (p_146085_0_ == Items.iron_horse_armor || p_146085_0_ == Items.golden_horse_armor || p_146085_0_ == Items.diamond_horse_armor || p_146085_0_ == ModEmeraldMaterial.emeraldHorseArmor));
        return p_146085_0_ == Items.iron_horse_armor || p_146085_0_ == Items.golden_horse_armor || p_146085_0_ == Items.diamond_horse_armor || p_146085_0_ == ModEmeraldMaterial.emeraldHorseArmor;
    }
    ...
    {
//        EMLogger.info("EntityCustomHorse getEyeHeight");
        return this.height;
    }

    public boolean replaceItemInInventory(int p_174820_1_, ItemStack p_174820_2_)
    {
    	EMLogger.info("EntityCustomHorse replaceItemInInventory(): int = " + p_174820_1_ + "; item = " + (p_174820_2_ == null ? "null" : p_174820_2_.getDisplayName()));
    ...
    public static class GroupData implements IEntityLivingData
        {
            ...
            {
                EMLogger.info("EntityCustomHorse::GroupData <init>");
